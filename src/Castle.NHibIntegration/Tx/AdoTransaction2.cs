namespace Castle.NHibIntegration.Tx
{
	...
	/// </summary>
	public class AdoTransaction2 : ITransaction
	{
		private static readonly IInternalLogger log = LoggerProvider.LoggerFor(typeof(AdoTransaction2));
		...
		public AdoTransaction2(ISessionImplementor session)
		{
