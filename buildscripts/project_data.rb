...
Projects = {
	:tx => {	
		...
		:description => "Castle Transactions enables a common interface to both .Net Transactions with LTM/Lightweight Transaction Manager.",
	...
	:io => {
		...
		:copyright => "Henrik Feldt & Sebastien Lamla",
		:authors => "Henrik Feldt",
		:company => "-",
